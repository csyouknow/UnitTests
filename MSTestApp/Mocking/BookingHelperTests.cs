...
namespace MSTestApp.Mocking
{
    ...
    class BookingHelperTests_OverlappingBookingsExist
    {
        ...
        //Initialize the objects and classes
        [SetUp]
        public void SetUp()
        {
            ...
            //Mocking a Iqueryable list to see if no overlapping bookings exists
        ...
        [Test]
        public void BookingStartsBeforeAndFinishesInTheMiddleOnAnExistingBooking_ReturnExistingBookingReference()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
        ...
        [Test]
        public void BookingStartsAndFinishesAfterAnExistingBookingButFinishesAfter_ReturnEmptyString()
        {
            var result = BookingHelper.OverlappingBookingsExist(new Booking
            {
                Id = 1,
        ...
        //private fields to return reusable dates and times to shorten our test code
